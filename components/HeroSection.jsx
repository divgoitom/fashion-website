    ...
    <div className="relative isolate z-0 bg-[url('/flowers.jpg')] bg-cover bg-center px-6 pt-14 lg:px-8 shadow-md">
      <div className="relative mx-auto max-w-2xl py-24">
        ...
        <div className="text-center">
          ...
          <button
            type="button"
            class="rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
          >
            Shop Now
          </button>
        </div>
